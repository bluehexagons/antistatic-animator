...
export const isKeyframeModified = (keyframes: Keyframe[], kf: Keyframe): boolean => {
...
export const resetBaseline = (keyframes: Keyframe[]): void => {
